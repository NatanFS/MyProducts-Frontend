        ...
        <div className="p-4 overflow-y-auto max-h-[70vh]">
          <form onSubmit={(e) => e.preventDefault()}>
            ...
            <input
              ...
              className={`block w-full mb-1 bg-gray-700 border ${
                validationErrors.name ? 'border-red-500' : 'border-gray-600'
              } rounded-lg px-4 py-2 text-gray-300 placeholder-gray-400 focus:ring-2 focus:ring-blue-500`}
            />
            ...
            <input
              ...
              className={`block w-full mb-1 bg-gray-700 border ${
                validationErrors.sales ? 'border-red-500' : 'border-gray-600'
              } rounded-lg px-4 py-2 text-gray-300 placeholder-gray-400 focus:ring-2 focus:ring-blue-500`}
            />
            ...
            <input
              ...
              className={`block w-full mb-1 bg-gray-700 border ${
                validationErrors.code ? 'border-red-500' : 'border-gray-600'
              } rounded-lg px-4 py-2 text-gray-300 placeholder-gray-400 focus:ring-2 focus:ring-blue-500`}
            />
